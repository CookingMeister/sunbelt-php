    ...
    <div class="row g-4 mt-1 mb-4">
        <div class="col-12">
            <div class="p-4 text-white rounded gradient-col gradient-info position-relative">
                ...
                <img src="img/laptop.jpg" alt="logo" class="img-fluid position-absolute product-img" style="max-width: 120px; right: 10%; top: 50%; transform: translateY(-50%);">
            </div>
        </div>
        <div class="col-sm-12 col-md-6">
            <div class="p-4 text-white rounded gradient-col gradient-success text-center">
                <img src="img/professionals.jpg" alt="logo" class="img-fluid mb-2 product-img" style="max-width: 150px;">
                <h3>Product 2</h3>
        ...
        <div class="col-sm-12 col-md-6">
            <div class="p-4 text-white rounded gradient-col gradient-warning text-center">
                <img src="img/database.jpg" alt="logo" class="img-fluid mb-2 product-img" style="max-width: 150px;">
                <h3>Product 3</h3>
        ...
        <div class="col-12">
            <div class="p-4 text-white rounded gradient-col gradient-danger text-end position-relative">
                ...
                <img src="img/engineer-server.jpg" alt="logo" class="img-fluid product-img position-absolute" style="max-width: 120px; left: 15%; top: 50%; transform: translateY(-50%);">
            </div>
        </div>
    </div>
